-- ============================================
-- TradeITM Analytics - MINIMAL WORKING VERSION
-- This creates everything EXCEPT subscribers tracking
-- ============================================
...
-- 6. Create analytics function (WITHOUT subscribers for now)
...
-- Success!
SELECT '✅ Core analytics tables created!' as status;
