...
// Text Gradients
export const GOLD_TEXT = "bg-gradient-to-r from-[#10B981] to-[#F1E5AC] bg-clip-text text-transparent"
...
// Hover Effects
export const HOVER_GLOW = "transition-all duration-300 hover:shadow-[0_0_20px_-5px_rgba(16, 185, 129,0.3)] hover:border-emerald-500/30"
...
export const BORDER_GOLD = "border border-[#10B981]/15 hover:border-[#10B981]/25 transition-colors"
...
// Buttons
export const BTN_CHAMPAGNE = "bg-gradient-to-r from-[#10B981] to-emerald-600 text-black font-medium hover:shadow-[0_0_30px_-10px_rgba(16, 185, 129,0.5)] transition-all duration-300"
...
export const STATUS_INFO = "text-[#10B981] bg-emerald-500/10 border-emerald-500/20"

// Animations
export const ANIMATE_PULSE_GOLD = "animate-pulse-subtle shadow-[0_0_30px_rgba(16, 185, 129,0.1)]"
