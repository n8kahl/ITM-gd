...
// Hover Effects
export const HOVER_GLOW = "transition-all duration-300 hover:shadow-[0_0_20px_-5px_rgba(212,175,55,0.3)] hover:border-[#D4AF37]/30"
...
// Borders
export const BORDER_LUXURY = "border border-white/10 hover:border-[#D4AF37]/20 transition-colors"
...
export const BORDER_HOLOGRAPHIC = "border border-white/10 hover:border-[#D4AF37]/30 transition-all duration-500"
...
// Buttons
export const BTN_CHAMPAGNE = "bg-gradient-to-r from-[#D4AF37] to-[#B8962E] text-black font-medium hover:shadow-[0_0_30px_-10px_rgba(212,175,55,0.5)] transition-all duration-300"
...
// Input Fields
export const INPUT_LUXURY = "bg-white/5 border border-white/10 text-white placeholder:text-white/30 focus:border-[#D4AF37] focus:bg-white/10 focus:outline-none transition-all duration-300 h-12"
export const INPUT_GLASS = "bg-[#0F0F10]/60 backdrop-blur-lg border border-white/8 text-white placeholder:text-white/40 focus:border-[#D4AF37]/50 focus:outline-none transition-all duration-300 h-12"
...
export const STATUS_INFO = "text-[#D4AF37] bg-[#D4AF37]/10 border-[#D4AF37]/20"
...
export const FOCUS_RING_GOLD = "focus:ring-2 focus:ring-[#D4AF37]/50 focus:ring-offset-2 focus:ring-offset-[#050505]"
