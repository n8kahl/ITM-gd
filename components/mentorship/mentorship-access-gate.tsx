...
export function MentorshipAccessGate({ children }: MentorshipAccessGateProps) {
  ...
  if (!hasAccess) {
    return (
      <div
        data-testid="mentorship-access-denied"
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-3">
            ...
            <h1 className="font-[family-name:var(--font-playfair)] text-2xl font-semibold text-white">
              Mentorship Access Required
            </h1>
            <p className="max-w-2xl text-sm text-white/65">
              Your account does not currently have the required Discord role to view Sniper Mentorship content.
              If this looks incorrect, ask support to verify your mentorship role assignment.
            </p>
            <div className="pt-1">
              <Link
                href="/members"
