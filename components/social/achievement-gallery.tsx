  ...
  useEffect(() => {
    async function fetchAchievements() {
      ...
      try {
        ...
        if (!json?.success) {
          throw new Error(json?.error || 'Failed to load achievements')
        }
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {item.author && (
                    <div className="mt-2 flex items-center gap-1.5">
                      ...
                      {resolveDiscordAvatarUrl(item.author.discord_avatar, item.author.discord_user_id) ? (
                        <Image
                            src={resolveDiscordAvatarUrl(item.author.discord_avatar, item.author.discord_user_id)!}
