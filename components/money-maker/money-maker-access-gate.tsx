...
export function MoneyMakerAccessGate({ children }: MoneyMakerAccessGateProps) {
  ...
  if (!hasAccess) {
    return (
      <div
        data-testid="money-maker-access-denied"
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-3">
            ...
            <h1 className="font-[family-name:var(--font-playfair)] text-2xl font-semibold text-white">
              Money Maker Access Required
            </h1>
            <p className="max-w-2xl text-sm text-white/65">
              Money Maker is currently restricted to backend admin accounts while the live strategy engine is validated.
              If this looks incorrect, ask support to verify your admin access.
            </p>
            <div className="pt-1">
              <Link
                href="/members"
