...
export const SPX_TELEMETRY_EVENT = {
  ...
  EXECUTION_FILL_REPORTED: 'spx_execution_fill_reported',
  EXECUTION_FILL_RECONCILED: 'spx_execution_fill_reconciled',
  EXECUTION_FILL_REPORT_FAILED: 'spx_execution_fill_report_failed',
  ...
  UX_FOCUS_MODE_CHANGED: 'spx_ux_focus_mode_changed',
  CHART_INTERACTION_TOOLTIP: 'spx_chart_interaction_tooltip',
  CHART_REPLAY_STATE_CHANGED: 'spx_chart_replay_state_changed',
  CHART_REPLAY_PROGRESS: 'spx_chart_replay_progress',
  CHART_SCENARIO_LANES_RENDERED: 'spx_chart_scenario_lanes_rendered',
  TRADE_JOURNAL_CAPTURED: 'spx_trade_journal_captured',
  ...
  CHART_LABEL_COLLISION: 'spx_chart_label_collision',
