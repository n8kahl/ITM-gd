...
export interface RRCalculatorParams {
    ...
    nextLevel: number // The next hourly level above (for long) or below (for short)
    tickSize?: number // minimum price increment, default 0.01
}
...
export interface RRResult {
    ...
    isValid: boolean // true if R:R >= 2.0
}
 ...
 */
export function calculateRR(params: RRCalculatorParams): RRResult {
