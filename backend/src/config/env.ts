...
const envSchema = z.object({
  ...
  SPX_SETUP_INVALIDATION_STREAK: z.string().default('3').transform(Number),
  SPX_SETUP_FLOW_DIVERGENCE_THRESHOLD: z.string().default('38').transform(Number),
  SPX_SETUP_REGIME_CONFLICT_CONFIDENCE_THRESHOLD: z.string().default('68').transform(Number),
  SPX_SETUP_STOP_CONFIRMATION_TICKS: z.string().default('2').transform(Number),
  ...
  SPX_MEMORY_ENGINE_ENABLED: booleanFromEnv.default(false),
  SPX_MULTI_TF_CONFLUENCE_ENABLED: booleanFromEnv.default(false),
