...
const DEFAULT_TABS = [
  ...
  { tab_id: 'library', label: 'Academy', icon: 'GraduationCap', path: '/members/academy/courses', required_tier: 'core', sort_order: 3, is_required: false, mobile_visible: false, is_active: true },
