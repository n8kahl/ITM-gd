...
const DEFAULT_TABS = [
  ...
  { tab_id: 'library', label: 'Academy', icon: 'GraduationCap', path: '/members/academy-v3', required_tier: 'core', sort_order: 5, is_required: false, mobile_visible: false, is_active: true },
