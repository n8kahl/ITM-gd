  ...
  return (
    <div className="flex min-h-[40vh] flex-col items-center justify-center px-4">
      <div className="glass-card-heavy mx-auto max-w-md rounded-2xl border border-white/10 p-8 text-center">
        <h2 className="text-lg font-semibold text-white">Failed to load lesson</h2>
        <p className="mt-2 text-sm text-zinc-400">We could not load this lesson right now.</p>
        <button
          type="button"
          onClick={reset}
