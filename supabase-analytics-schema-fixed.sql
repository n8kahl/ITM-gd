-- ============================================
-- TradeITM Analytics Database Schema (FIXED)
-- ============================================
...
-- Update existing subscribers table - add all columns including created_at
...
-- Create policies to allow inserts from anyone (for tracking)
...
-- Allow reads for everyone (you can restrict this later with proper auth)
